 ...
 * @param {Model} model
 * @param {string} token
 * @returns {import('./untilsServices.js').Message}
 */
    ...
    await authenticationServices
      ...
      .then(async (message) => {
        ...
        try {
          ...
          resolve(
            messageCreater(1, "success", "Create model successful!", newModelDB)
          );
        } catch (error) {
    ...
    await authenticationServices
      ...
      .then(async (message) => {
        ...
        try {
          ...
          resolve(
            messageCreater(1, "success", `Found ${rows.length} models`, {
              count,
              rows,
            })
          );
